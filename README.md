...
```bash
$ cargo install --git https://github.com/gbbirkisson/regop.git --tag 0.5.2
```
...
<!--x-release-please-start-version-->
```bash
$ curl --proto '=https' --tlsv1.2 -LsSf https://github.com/gbbirkisson/regop/releases/download/0.5.2/regop-installer.sh | sh
```
<!--x-release-please-end-->
